...
class NewDataSource:
    """
    Data source for NewTradingEnvironment
...
class NewTradingEnvironment(gym.Env):
    ...
    def __init__(self,
        ...
        self.trading_cost_bps = trading_cost_bps
        self.time_cost_bps = time_cost_bps
        self.data_source = NewDataSource(trading_days=self.trading_days)
        self.simulator = NewTradingSimulator(steps=self.trading_days,
